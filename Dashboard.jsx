...
import { SafeAreaView, StyleSheet, Text, View, StatusBar, Image, TouchableOpacity, BackHandler, Alert } from "react-native";
  ...
  return (
    <SafeAreaView style={styles.MainDashboard}>
      ...
      <View style={styles.whiteBackground}>
        ...
        <View>
          <Image source={require("../../assets/splash.png")} style={styles.logo1}/>
        </View>
        ...
        <View style={styles.attendanceBackground}> 
          ...
          <TouchableOpacity style={styles.attendance1}>
            <Text style={styles.attendance2} onPress={() => navigation.navigate('AttendanceDashboard')}>Attendance Panel</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.employeelistBackground}> 
          ...
          <TouchableOpacity style={styles.employeeList1}>
            <Text style={styles.employeeList2} onPress={() => navigation.navigate('EmployeeList')}>Employee List</Text>
          </TouchableOpacity>
        </View>

        <View style={styles.reportBackground}> 
          <Text style={styles.phrase3}>Shows an attendance summary of a month</Text>
          <TouchableOpacity style={styles.attendanceReportSummary1}>
            <Text style={styles.attendanceReportSummary2}>Attendance Report Summary</Text>
          </TouchableOpacity>
        </View>
